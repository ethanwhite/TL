...
## 1. Plot observed against expected var
#tl_pars_par = tl.get_tl_par_file('TL_form_partition.txt')
##study_sig = tl_pars_par['study'][tl_pars_par['p_obs'] < 0.05]
#study_sig = tl_pars_par['study'] # Edit 08/23/14: plot all regardless of significance
...
#expc_par, expc_comp, expc_upper_par, expc_upper_comp, \
    #expc_lower_par, expc_lower_comp, data_type_par, \
    #data_type_comp = [], [], [], [], [], [], [], []
...
#for i in xrange(len(var_par)):
    ...
    #data_type_par.append(study_info['type'][study_info['study'] == var_par['study'][i]])
    #if np.percentile(expc_sample_par, 2.5)< var_par['var'][i] < np.percentile(expc_sample_par, 97.5): i_par += 1
    ...
    #data_type_comp.append(study_info['type'][study_info['study'] == var_comp['study'][i]])
    #if np.percentile(expc_sample_comp, 2.5) < var_comp['var'][i] < np.percentile(expc_sample_comp, 97.5): i_comp += 1
    
#fig = plt.figure(figsize = (7, 3.8)) 
#ax_par = plt.subplot(121) 
#tl.plot_obs_expc(var_par['var'], expc_par, expc_upper_par, expc_lower_par, data_type_par, loglog = True, legend = True, ax = ax_par)
#plt.xlabel('Empirically Observed Variance', fontsize = 8)
#plt.ylabel('Variance for Configurations in Feasible Set', fontsize = 8)
#plt.title('Partitions')
#ax_comp = plt.subplot(122) 
#tl.plot_obs_expc(var_comp['var'], expc_comp, expc_upper_comp, expc_lower_comp, data_type_comp, loglog = True, ax = ax_comp)
#plt.xlabel('Empirically Observed Variance', fontsize = 8)
#plt.ylabel('Variance for Configurations in the Feasible Set', fontsize = 8)
#plt.title('Compositions')
#plt.savefig('exp_obs_variance.png', dpi = 600)

#print "Observed variance within 95% CI for partition:", i_par / len(var_par)
#print "Observed variance within 95% CI for composition:", i_comp / len(var_comp)

## 2. Plot expected and observed mean-var relationship
#fig = plt.figure(figsize = (7, 3.8)) 
#ax_par = plt.subplot(121) 
#tl.plot_mean_var(var_par['mean'], var_par['var'], expc_par, data_type_par, ax = ax_par)
#plt.title('Partition')
#ax_comp = plt.subplot(122) 
#tl.plot_mean_var(var_comp['mean'], var_comp['var'], expc_comp, data_type_comp, ax = ax_comp)
#plt.title('Composition')
#plt.savefig('var_against_mean.png', dpi = 600)

## 3. Plot expected vs observed b and intercept
#study_info = tl.get_study_info('study_taxon_type.txt')
#tl_pars_par = tl.get_tl_par_file('TL_form_partition.txt')
#tl_pars_comp = tl.get_tl_par_file('TL_form_composition.txt')
##tl_pars_par = tl_pars_par[tl_pars_par['p_obs'] < 0.05]
##tl_pars_comp = tl_pars_comp[tl_pars_comp['p_obs'] < 0.05]

#tl_type_par, tl_type_comp = [], []
#for i in range(len(tl_pars_par)):
    #tl_type_par.append(study_info['type'][study_info['study'] == tl_pars_par['study'][i]])
    #tl_type_comp.append(study_info['type'][study_info['study'] == tl_pars_comp['study'][i]])
    
#fig = plt.figure(figsize = (7, 3.8)) 
#ax_par = plt.subplot(121) 
#tl.plot_obs_expc(tl_pars_par['b_obs'], tl_pars_par['b_expc'], tl_pars_par['b_upper'], \
                 #tl_pars_par['b_lower'], tl_type_par, loglog = False, ax = ax_par, legend = True)
#plt.xlabel('Exponent b for Empirical TL', fontsize = 8)
#plt.ylabel('Exponent b for the Feasible Set', fontsize = 8)
#plt.title('Partitions')

#ax_comp = plt.subplot(122) 
#tl.plot_obs_expc(tl_pars_comp['b_obs'], tl_pars_comp['b_expc'], tl_pars_comp['b_upper'], \
                 #tl_pars_comp['b_lower'], tl_type_comp, loglog = False, ax = ax_comp)
#plt.xlabel('Exponent b for Empirical TL', fontsize = 8)
#plt.ylabel('Exponent b for the Feasible Set', fontsize = 8)
#plt.title('Compositions')
#plt.savefig('exp_obs_b.png', dpi = 600)

## 4. Compare distribution of of empirical and expected exponent b
#tl_pars_par = tl.get_tl_par_file('TL_form_partition.txt')
#study_sig = tl_pars_par['study'][tl_pars_par['p_obs'] < 0.05]
#study_info = tl.get_study_info('study_taxon_type.txt')
...
#for study in np.unique(var_par['study']):
    ...
    #for i in xrange(1000):
        ...
        #b_par.append(stats.linregress(np.log(mean_par), np.log(sample_par_i))[0])
        ...
        #b_comp.append(stats.linregress(np.log(mean_comp), np.log(sample_comp_i))[0])
        
#fig = plt.figure(figsize = (7, 3.8)) 
#ax_par = plt.subplot(121) 
#tl.plot_dens(b_obs, b_par, b_type, ax = ax_par, legend = True, loc = 1)
#plt.xlabel('Exponent b', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)
#plt.title('Partition')

#ax_comp = plt.subplot(122) 
#tl.plot_dens(b_obs, b_comp, b_type, ax = ax_comp)
#plt.xlabel('Exponent b', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)
#plt.title('Composition')
#plt.savefig('Density_of_b.png', dpi = 600)

# 5. Compare the full distribution of empirical TLs and those from the feasible sets
study_info = tl.get_study_info('study_taxon_type.txt')
...
#tl.plot_dens(p_obs, p_par, b_type, ax = ax_p, legend = True, loc = 1, vline = 0.05, xlim = [0, 0.2])
#plt.xlabel('p-value for b', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)

#ax_curv = plt.subplot(142)
#tl.plot_dens(pcurv_obs, pcurv_par, b_type, ax = ax_curv, vline = 0.05, xlim = [0, 1])
#plt.xlabel('p-value for quadratic term', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)

#ax_r2 = plt.subplot(143)
#tl.plot_dens(r2_obs, r2_par, b_type, ax = ax_r2, xlim = [0, 1])
#plt.xlabel('R^2', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)

#ax_b = plt.subplot(144) 
#tl.plot_dens(b_obs, b_par, b_type, ax = ax_b)
#plt.xlabel('Exponent b', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)
#plt.savefig('Density_shapes_partition.png', dpi = 600)

#fig = plt.figure(figsize = (14, 3.8)) 
#ax_p = plt.subplot(141)
#tl.plot_dens(p_obs, p_comp, b_type, ax = ax_p, legend = True, loc = 1, vline = 0.05, xlim = [0, 0.2])
#plt.xlabel('p-value for b', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)

#ax_curv = plt.subplot(142)
#tl.plot_dens(pcurv_obs, pcurv_comp, b_type, ax = ax_curv, vline = 0.05, xlim = [0, 1])
#plt.xlabel('p-value for quadratic term', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)

#ax_r2 = plt.subplot(143)
#tl.plot_dens(r2_obs, r2_comp, b_type, ax = ax_r2, xlim = [0, 1])
#plt.xlabel('R^2', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)

#ax_b = plt.subplot(144) 
#tl.plot_dens(b_obs, b_comp, b_type, ax = ax_b)
#plt.xlabel('Exponent b', fontsize = 8)
#plt.ylabel('Density', fontsize = 8)
#plt.savefig('Density_shapes_composition.png', dpi = 600)
...
## 6. Randomly sample three Q-N pairs and three TLs to illustrate the full distribution from the feasible set
#var_par = tl.get_var_sample_file('taylor_QN_var_predicted_partition_full.txt')
#var_comp = tl.get_var_sample_file('taylor_QN_var_predicted_composition_full.txt')
#tl_pars_par = tl.get_tl_par_file('TL_form_partition.txt')
#random.seed(33) 
...
#random.seed(44)
#tl_sets = random.sample(np.unique(var_par['study']), 3) 

#fig = plt.figure(figsize = (10.5, 7)) 
## Plot the 3 Q-N pairs 
#for i, qn_pair in enumerate(qn_sets):
    #ax_qn = plt.subplot(2, 3, i + 1)
    ...
    #ax_qn.annotate('Q = ' + str(dat_row_par[1]), xy = (0.75, 0.92), xycoords = 'axes fraction', fontsize = 10)
    #ax_qn.annotate('N = ' + str(dat_row_par[2]), xy = (0.75, 0.82), xycoords = 'axes fraction', fontsize = 10)
    #plt.xlabel('Variance', fontsize = 8)
    #plt.ylabel('Density', fontsize = 8)

## Plot the 3 TLs
#for j, tl_id in enumerate(tl_sets):
    #study_par = var_par[var_par['study'] == tl_id]
    #study_comp = var_comp[var_comp['study'] == tl_id]
    #b_obs = (tl_pars_par['b_obs'][tl_pars_par['study'] == tl_id])[0]
    #b_par = []
    #b_comp = []
    #for k in xrange(1000):
        #study_par_k = [study_par[x][k + 5] for x in xrange(len(study_par))]
        #mean_par = [study_par['mean'][p] for p in xrange(len(study_par)) if study_par_k[p] != 0]
        #study_par_k = [study_par_k[p] for p in xrange(len(study_par_k)) if study_par_k[p] != 0]
        #b_par_k, inter, r, p, std_err = stats.linregress(np.log(mean_par), np.log(study_par_k))
        #b_par.append(b_par_k)
        
        #study_comp_k = [study_comp[x][k + 5] for x in xrange(len(study_comp))]
        #mean_comp = [study_comp['mean'][p] for p in xrange(len(study_comp)) if study_comp_k[p] != 0]
        #study_comp_k = [study_comp_k[p] for p in xrange(len(study_comp_k)) if study_comp_k[p] != 0]
        #b_comp_k, inter, r, p, std_err = stats.linregress(np.log(mean_comp), np.log(study_comp_k))
        #b_comp.append(b_comp_k)        
    
    #ax_b = plt.subplot(2, 3, j + 4)
    #tl.plot_dens_par_comp_single_obs(b_obs, b_par, b_comp, ax = ax_b)
    #ax_b.annotate('Dataset: ' + tl_id, xy = (0.05, 0.92), xycoords = 'axes fraction', fontsize = 10)
    #plt.xlabel('Exponent b', fontsize = 8)
    #plt.ylabel('Density', fontsize = 8)     
#plt.subplots_adjust(wspace = 0.29, hspace = 0.29)
#plt.savefig('Sample_dist_var_b.png', dpi = 600)

## 7. Combine plots for var and for b
#tl_pars_par = tl.get_tl_par_file('TL_form_partition.txt')
##study_sig = tl_pars_par['study'][tl_pars_par['p_obs'] < 0.05]
#study_sig = tl_pars_par['study'] # Edit 08/23/14: plot all regardless of significance
...
#ax_par = plt.subplot(223) 
#tl.plot_obs_expc(tl_pars_par['b_obs'], tl_pars_par['b_expc'], tl_pars_par['b_upper'], \
                 #tl_pars_par['b_lower'], tl_type_par, loglog = False, ax = ax_par)
#plt.xlabel('Exponent b for Empirical TL', fontsize = 8)
#plt.ylabel('Exponent b for the Feasible Set', fontsize = 8)

#ax_comp = plt.subplot(224) 
#tl.plot_obs_expc(tl_pars_comp['b_obs'], tl_pars_comp['b_expc'], tl_pars_comp['b_upper'], \
                 #tl_pars_comp['b_lower'], tl_type_comp, loglog = False, ax = ax_comp)
#plt.xlabel('Exponent b for Empirical TL', fontsize = 8)
#plt.ylabel('Exponent b for the Feasible Set', fontsize = 8)
#plt.subplots_adjust(wspace = 0.29, hspace = 0.29)
#plt.savefig('var_and_b.png', dpi = 600)

# 8. New figure 1 - visual representation using three studies
...
# 9. Combine plots for var and for b, modified following R2's suggestion
# The points are separated by whether their 95% quantile is above, below or overlapping the emp value.
tl_pars_par = tl.get_tl_par_file('out_files/TL_form_partition.txt')
study_sig = tl_pars_par['study'] # Edit 08/23/14: plot all regardless of significance
...
## 10. New figure B1 - remove the lower panel
var_par = tl.get_var_sample_file('out_files/taylor_QN_var_predicted_partition_full.txt')
var_comp = tl.get_var_sample_file('out_files/taylor_QN_var_predicted_composition_full.txt')
tl_pars_par = tl.get_tl_par_file('out_files/TL_form_partition.txt')
random.seed(4) 
